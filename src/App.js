// Modified App.js passing video props to each industry page
          ...
          <div className="relative min-h-screen text-white font-sans">
            ...
            <header className="flex justify-between items-center p-6 sticky top-0 bg-black/40 backdrop-blur-md z-10 shadow-md">
              <div className="flex items-center space-x-3">
                <motion.img whileHover={{ scale: 1.2, rotate: 10 }} src="/assets/medias/Logo.png" alt="Dazzlo Logo" className="h-10 w-10 animate-pulse" />
            ...
            <section className="flex flex-col items-center justify-center text-center py-32 px-4 animate-fadeIn">
              <motion.h2 animate={{ y: [0, -20, 0], scale: [1, 1.1, 1] }} transition={{ repeat: Infinity, repeatType: 'loop', duration: 1, ease: 'easeInOut' }} className="text-5xl font-extrabold bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 bg-clip-text text-transparent tracking-widest mb-6">
            ...
            <section id="industries" className="px-8 py-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {industries.map((item, idx) => (
                  <motion.div key={idx} whileHover={{ scale: 1.05, boxShadow: "0px 0px 20px rgba(255,255,255,0.5)" }} className="relative rounded-xl overflow-hidden shadow-lg transform transition-transform cursor-pointer h-48">
                    <Link to={item.path}>
